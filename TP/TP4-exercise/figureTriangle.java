public class figureTriangle extends Forma {
    private double ladoA;
    private double ladoB;
    private double ladoC;

    public figureTriangle(double ladoA, double ladoB, double ladoC, String cor) {
        super(cor);
    ...
    public String toString(){
        return "Triangle: " + this.ladoA + " " + this.ladoB + " " + this.ladoC + " " + "Perimeter=" + Math.round(this.getPerimeter()) + " " + "Area=" + Math.round(this.getArea()) + " Cor=" + this.cor;
    }
